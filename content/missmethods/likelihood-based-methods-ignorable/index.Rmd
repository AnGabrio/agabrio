...
\\[
l(\\theta \\mid y) = -\\frac{n}{2}\\text{ln}(2\\pi) -\\frac{n}{2}\\text{ln}(\\sigma\^2) - \\frac{\\sum\_{i=1}\^n \\left(y\_i - \\mu\_i \\right)\^2}{2\\sigma\^2}.
\\]
...
\\[
l(\\theta \\mid y,x)=\\sum\_{i=1}\^n \\left[\\frac{\\left(y\_i\\delta\\left(x\_i,\\beta\\right)-b\\left(\\delta\\left(x\_i,\\beta\\right)\\right) \\right)}{\\phi}+c\\left(y\_i,\\phi\\right)\\right],
\\]
