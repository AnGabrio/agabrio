...
\\[
\\bar{y}=\\frac{1}{n}\\sum\_{i=1}\^ny\_i, 
\\]
...
\\[
\\sum\_{i=1}\^n\\frac{c\_i}{\\pi(z\_i)}(y\_i-\\mu)=0, 
\\]
...
\\[
\\mu\_{ipw}=\\left(\\sum\_{i=1}\^n \\frac{c\_i}{\\pi(z\_i)} \\right)\^{-1} \\sum\_{i=1}\^n \\frac{c\_iy\_i}{\\pi(z\_i)},
\\]
...
\\[
\\text{logit}(\\pi)=\\alpha\_0 + \\alpha\_1z.
\\]
