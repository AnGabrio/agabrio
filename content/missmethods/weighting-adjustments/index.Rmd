...
\\[
\\bar{y}\_{w} = \\frac{1}{n\_r}\\sum\_{i=1}\^{n\_r}w\_iy\_i,
\\]
...
\\[
\\text{Var}\\left(\\frac{1}{n\_{r}}\\sum\_{i=1}\^{n\_{r}}w\_iy\_i \\right) = \\frac{\\sigma\^2}{n\_{r}\^2}\\left(\\sum\_{i=1}\^{n\_{r}}w\_{i}\^{2} \\right) = \\frac{\\sigma\^2}{n\_{r}}(1+\\text{cv}\^2(w\_i)),
\\]
