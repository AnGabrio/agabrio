...
\\[
f(y\_1,y\_2,r \\mid \\omega) = f(y\_1 \\mid \\theta)f(r \\mid y\_1,y\_2,\\psi),
\\]
...
\\[
g(\\pi\_i) = \\psi\_0 + \\psi\_1y\_{i1} + \\psi\_2y\_{i2},
\\]
...
\\[
h\\left(t\_j \\mid \\bar{Y}\_{j}\\right) = \\text{Prob}\\left(R\_j = 0 \\mid R\_{j-1} = 1, Y\_{1},\\ldots,Y\_{j} \\right).
\\]
