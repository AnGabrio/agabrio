...
\\[
\\bar{y}\_{HD}=\\frac{(n\_{cc}\\bar{y}\_{cc}+(n-n\_{cc})\\bar{y}\^{\\star})}{n},
\\]
...
\\[
E[\\bar{y}\_{HD}]=E[E[\\bar{y}\_{HD}\\mid y\_{obs}]] \;\;\; \\text{and} \;\;\; Var(\\bar{y}\_{HD})=Var(E[\\bar{y}\_{HD} \\mid y\_{obs}]) + E[Var(\\bar{y}\_{HD} \\mid y\_{obs})],
\\]
