...
```{r diagnostic, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE,error=FALSE,message=FALSE}
basic.mod.mcmc2=as.mcmc(basic.mod)
```
...
denplot(basic.mod.mcmc2, parms = c("beta0","beta1"))
traplot(basic.mod.mcmc2, parms = c("beta0","beta1"))
```
