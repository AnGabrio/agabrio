...
date: 2020-02-09T21:13:14-05:00
categories: ["R", "anova", "STAN", "mixed effects model"]
tags: ["tutorials", "STAN", "mixed effects model", "anova"]
authors: ["Andrea Gabrio"]
bibliography: [citations_stan10.bib]
draft: no
slug: nested-anova-stan
---
...
```{r fact_anova1, eval=TRUE, echo=FALSE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r fact_anova1_tab, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
fact_anova_table
```

The corresponding `R` syntax is given below.

```{r fact_anova1_tab_r, eval=FALSE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r exp1_data, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r full_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
rstanString="
data{
   int n;
   int nA;
...
```{r full2_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
rstan2String="
data{
   int n;
   int nB;
...
```{r data2_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r chain2_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r fit2_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r matrix_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
rstanString2="
data{
   int n;
   int nB;
...
```{r hierarchical_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
rstanString3="
data{
   int n;
   int nA;
...
```{r data_model3, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r SD_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
rstanString4="
data{
   int n;
   int nA;
...
```{r generate_data_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
set.seed(123)
nTreat <- 3
nSites <- 15
nSitesPerTreat <- nSites/nTreat
...
```{r exp1_data_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#Effects of treatment
...
```{r fit_ex2_p1, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(nlme)
...
```{r full_model_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
rstanString="
data{
   int n;
   int nSite;
...
```{r matrix_model_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
rstanString2="
data{
   int n;
   int nSite;
