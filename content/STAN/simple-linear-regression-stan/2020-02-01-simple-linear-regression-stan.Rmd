...
draft: no
slug: simple-linear-regression-stan
---
...
```{r code_stan, eval=TRUE, echo=FALSE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
cat("
					  data {
...
```{r code_model2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
modelStringv2 = "
data { 
