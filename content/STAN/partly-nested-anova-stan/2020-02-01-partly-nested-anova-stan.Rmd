...
date: 2020-02-11T21:13:14-05:00
categories: ["R", "anova", "STAN", "split-plot", "repeated measures"]
tags: ["tutorials", "STAN", "split-plot", "repeated measures", "anova"]
authors: ["Andrea Gabrio"]
bibliography: [citations_stan12.bib]
draft: no
slug: partly-nested-anova-stan
---
...
```{r copper_data, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
