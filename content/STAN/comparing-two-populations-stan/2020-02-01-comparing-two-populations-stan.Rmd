...
categories: ["R", "one sample t-test", "STAN"]
tags: ["tutorials", "STAN", "population differences"]
...
```{r mcmc_diagv2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r mcmc_diagv3, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#traceplots
...
```{r mcmc_diagv4, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(bayesplot)
...
```{r mcmc_eff_size, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
mcmc = as.matrix(data.stan.means)
## Cohen's D
