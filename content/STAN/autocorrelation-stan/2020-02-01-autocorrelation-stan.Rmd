...
date: 2020-02-08T21:13:14-05:00
categories: ["R", "autocorrelation", "STAN"]
tags: ["tutorials", "STAN", "autocorrelation"]
...
```{r temp_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
stanString = "
  data {
  int<lower=1> n;
  vector [n] y;
...
```{r temp_model_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
stanString = "
functions { 
...
```{r mcmc_diag2_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#Raftery diagnostic
raftery.diag(mcmc)
```

```{r mcmc_diag3_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#Autocorrelation diagnostic
autocorr.diag(mcmc)
```

```{r mcmc_diag4_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
