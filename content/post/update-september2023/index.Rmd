...
```{r fit_bn, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
model_bn <- "
model {
...
```{r fit2_bn, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
#save data input
n <- dim(data_sim_ec)[1]
...
We are now ready to fit the model, whic we can do by typing

```{r fit3_bn, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
#fit model
...
```{r fit4_bn, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
#posterior results
print(jmodel_bn)
```
...
```{r fit5_bn, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r fit6_bn, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE, fig.width=8, fig.height=8}
...
```{r fit7_bn, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE, fig.width=8, fig.height=8}
