...
```{r fit_bg, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
model_bg <- "
model {
...
```{r fit2_bg, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
#save data input
n <- dim(data_sim_ec)[1]
...
```{r fit5_bg, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
#obtain estimates of means by arm
...
```{r fit7_bg, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE, fig.width=8, fig.height=8}
