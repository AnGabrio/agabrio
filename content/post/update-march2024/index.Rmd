...
```{r data_rasch_sim, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
set.seed(7689)
...
```{r data_rasch_sim_print, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
set.seed(7689)
...
```{r fit_rasch, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
#laod package
library(eRm)
...
```{r fit_rasch2, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
#print estimates
...
```{r fit_rasch3, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
#item 2
...
```{r test_rasch, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
gr <- cut(
  rowSums(items),
  breaks=c(0,2,5),
  include.lowest = TRUE)
...
```{r test_rasch2, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r test_rasch3, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
itemfit(p.param)
...
```{r test_rasch4, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r test_rasch5, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
s <- rowSums(items)
table(s)
...
```{r test_rasch6, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
