...
So, without further delay and with my apologies to all health economists who hoped for another post on CEA (sorry!), let me begin with presenting my example which is mostly inspired from another publibly available simulation example that can be found [here](https://rnahumaf.github.io/Health/Statistics/Simulation.nb.html). 
...
```{r dataset_sample1, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r dataset_mult_samples, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
# Real RR
...
```{r dataset_casecontrol, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r dataset_compare, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r dataset_rr_or, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
