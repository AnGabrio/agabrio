...
```{r descr, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE, results='asis'}
library(dplyr)
library(knitr)
library(kableExtra)
...
```{r lm, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r lm.means, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
library(emmeans)
emmeans(lm_Q,~ trtf)
emmeans(lm_TC,~ trtf)
```
...
```{r bcea, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
library(BCEA)
...
```{r cea_plots, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE, fig.width=8, fig.height=8}
