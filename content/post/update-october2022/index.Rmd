...
```{r long_format, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
library(reshape)
...
```{r lmm, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
library(nlme)
...
```{r lmm_summary, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
library(nlme)
summary(LMM_u)
...
```{r lmm_emmean, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
library(emmeans)
...
```{r lmm_mu_ec, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r lmm_delta_ec, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
