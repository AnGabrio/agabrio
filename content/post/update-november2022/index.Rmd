...
```{r linmod, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r model2, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
...
```{r emmean, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
library(emmeans)
...
```{r sur, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
library(systemfit)
