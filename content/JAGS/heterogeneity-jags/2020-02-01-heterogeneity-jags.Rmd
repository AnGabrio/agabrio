...
categories: ["R", "heterogeneity", "JAGS", "heteroskedasticity"]
tags: ["tutorials", "JAGS", "heterogeneity", "heteroskedasticity"]
authors: ["Andrea Gabrio"]
bibliography: [citations_jags8.bib]
draft: no
slug: heterogeneity-jags
---
...
```{r heterosk_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
modelString = "
  model {
  #Likelihood
  for (i in 1:n) {
