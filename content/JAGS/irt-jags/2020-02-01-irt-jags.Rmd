...
categories: ["R", "JAGS", "item response theory"]
tags: ["tutorials", "JAGS", "item response theory"]
...
The 1PLM is used for data collected on $n$ individuals who have each given responses on $p$
different items. The items have binary outcomes, i.e. the items are scored as $1$ if correct
and $0$ if not. The $i$-th individual in the sample is assumed to have a latent ability $\theta_i$, and the $i$-th individual's response on the $j$-th item is a random variable $Y_{ij}$ with a Bernoulli distribution. The probability that the $i$-th individual correctly answers the $j$-th item (i.e. the probability that $Y_{ij} = 1$) is assumed to have the following IRF form:
...
```{r data_read, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r prepro, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
Y<-data_dicho[,4:8]
n<-nrow(Y)
p<-ncol(Y)
...
```{r jags_code1, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
model1<-"
model {
 for (i in 1:n){
  for (j in 1:p){
...
```{r fit_model, eval=FALSE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(R2jags)
library(coda)
set.seed(3456)
...
```{r fit_model_save, eval=TRUE, echo=FALSE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(R2jags)
library(coda)
set.seed(3456)
#saveRDS(m1.r2jags,"m1.r2jags.rds")
m1.r2jags<-readRDS("m1.r2jags.rds")
```
...
```{r icc1, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r iic1, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r iic1tot, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r diag_m1, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(bayesplot)
library(ggplot2)
...
```{r theta1, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r jags_code2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
model2<-"
model {
 for (i in 1:n){
  for (j in 1:p){
...
```{r fit_model2, eval=FALSE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
m2.r2jags <- jags(data = data_list, inits = NULL, parameters.to.save = params,
    model.file = "model2PLM.txt", n.chains = nChains, n.iter = nIter,
    n.burnin = burnInSteps, n.thin = thinSteps)
```

```{r fit_model2_save, eval=TRUE, echo=FALSE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#saveRDS(m2.r2jags,"m2.r2jags.rds")
m2.r2jags<-readRDS("m2.r2jags.rds")
```
...
```{r icc2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r iic2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#plot iic for each individual with respect to each of the 5 items
neg_prob<-1-prob
information<-prob*neg_prob
...
```{r iic2tot, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#plot iic for each individual with respect to whole test
...
```{r diag_m2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r crit, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(loo)
...
```{r theta2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#summary stats for theta across both iterations and individuals
summary(theta)
...
```{r jags_code3, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
model3<-"
model {
 for (i in 1:n){
  for (j in 1:p){
...
```{r fit_model3, eval=FALSE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
m3.r2jags <- jags(data = data_list, inits = NULL, parameters.to.save = params,
    model.file = "model3PLM.txt", n.chains = nChains, n.iter = nIter,
    n.burnin = burnInSteps, n.thin = thinSteps)
```

```{r fit_model3_save, eval=TRUE, echo=FALSE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#saveRDS(m3.r2jags,"m3.r2jags.rds")
m3.r2jags<-readRDS("m3.r2jags.rds")
```
...
```{r icc3, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r iic3, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#plot iic for each individual with respect to each of the 5 items
neg_prob<-1-prob
...
```{r iic3tot, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#plot iic for each individual with respect to whole test
...
```{r diag_m3, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r crit2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#extract log-likelihood
...
```{r theta3, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
#summary stats for theta across both iterations and individuals
summary(theta)
...
The use of `JAGS` software to estimate IRT models allows the user to alter existing
