...
categories: ["R", "anova", "JAGS", "mixed effects model"]
tags: ["tutorials", "JAGS", "mixed effects model", "anova"]
authors: ["Andrea Gabrio"]
bibliography: [citations_jags10.bib]
draft: no
slug: netsed-anova-jags
---
...
```{r R2sd_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r summaries_graph, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r R2sd_model_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
