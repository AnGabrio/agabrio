...
categories: ["R", "anova", "JAGS", "randomised complete block"]
tags: ["tutorials", "JAGS", "randomised complete block", "anova"]
...
```{r exp2_data, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(car)
...
```{r comp_test, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r exp2_data_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r exp3_data_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(nlme)
...
```{r matrix_model_acf_ex2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
modelString3="
model {
   #Likelihood
   y[1]~dnorm(mu[1],tau)
