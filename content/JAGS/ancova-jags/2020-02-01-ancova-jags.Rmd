---
title: "Analysis of Covariance - JAGS"
author: "Andrea Gabrio"
date: 2020-02-05T21:13:14-05:00
categories: ["R", "ancova", "JAGS", "factor analysis"]
tags: ["tutorials", "JAGS", "ancova", "factor analysis"]
...
```{r ancova_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
modelString = "
  model {
  #Likelihood
  for (i in 1:n) {
...
```{r mcmc_add, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
print(data.r2jags)
...
```{r eff_pop1, eval=TRUE, echo=FALSE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
mcmc = data.r2jags$BUGSoutput$sims.matrix
head(mcmc)
