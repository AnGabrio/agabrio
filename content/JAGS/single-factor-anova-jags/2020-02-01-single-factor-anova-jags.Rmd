...
categories: ["R", "anova", "JAGS", "factor analysis"]
tags: ["tutorials", "JAGS", "anova", "factor analysis"]
authors: ["Andrea Gabrio"]
bibliography: [citations_jags5.bib]
draft: no
slug: single-factor-anova-jags
---
...
```{r anova, eval=TRUE, echo=FALSE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r anova_tab, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
anova_table
```

and corresponding `R` syntax.

```{r anova_tab_r, eval=FALSE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r anova_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
modelString = "
  model {
  #Likelihood
  for (i in 1:n) {
...
```{r anova_model2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
modelString2 = "
  model {
  #Likelihood
  for (i in 1:n) {
