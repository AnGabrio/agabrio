...
date: 2020-02-12T21:13:14-05:00
categories: ["R", "JAGS", "goodness of fit tests", "frequency analysis"]
tags: ["tutorials", "JAGS", "goodness of fit tests", "frequency analysis"]
...
```{r model_data, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r model_mcmc, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
params <- c("p")
nChains = 2
burnInSteps = 1000
thinSteps = 1
...
```{r model_mcmc_v2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
library(R2jags)
...
```{r model2_mcmc, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
params <- c("p")
nChains = 2
burnInSteps = 1000
thinSteps = 50
...
```{r model_data_gen, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
# The observed item frequencies
obs <- c(15, 9, 23)
...
```{r model_mcmc_par, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r model_mcmc_fit, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
# Fit the model for the 1:1:1 ratio
...
```{r mcmc_diag_v2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
...
```{r model2_mcmc1, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
print(data.r2jags2)
```
...
```{r model2_mcmc2, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
print(data.r2jags2.1)
```
...
```{r model2_expl, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
