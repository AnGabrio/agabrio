...
draft: no
slug: simple-linear-regression-jags
---
...
```{r scatter, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
# scatterplot
library(car)
...
When using the `jags` function (`R2jags` package), it is not necessary to provide initial values. However, if they are to be supplied, the inital values must be provided as a list of the same length as the number of chains. Then print the results.
