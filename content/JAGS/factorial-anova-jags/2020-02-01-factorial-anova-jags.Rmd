...
categories: ["R", "anova", "JAGS", "factor analysis", "factorial designs"]
tags: ["tutorials", "JAGS", "anova", "factor analysis", "factorial designs"]
authors: ["Andrea Gabrio"]
bibliography: [citations_jags7.bib]
draft: no
slug: factorial-anova-jags
---
...
```{r fact_anova_model, eval=TRUE, echo=TRUE, comment=NA, warning=FALSE, error=FALSE, message=FALSE}
modelString = "
  model {
  #Likelihood
  for (i in 1:n) {
